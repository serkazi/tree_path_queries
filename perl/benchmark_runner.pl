...
# system("$executable --benchmark_filter=$queries_to_filter $data_path $num_queries $K_val");
my $command_to_run = "$executable --benchmark_filter=$queries_to_filter $data_path";
printf("Running: %s\n",$command_to_run);
