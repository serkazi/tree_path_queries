...
my $valgrind_command= "valgrind --tool=massif --heap=yes --stacks=no --depth=3  --max-snapshots=1000 --time-unit=i --detailed-freq=5 --massif-out-file=outfile ".$executable ." ".$data_path."input";
